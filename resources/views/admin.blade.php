...
<body>
    ...
    <div>
        <div>
            ...
            <div>
                <h1>Événements</h1>
                <a href="{{ route('evenement.create') }}">Ajouter</a>
                @foreach($evenements as $evenement)
                    <article>
                        ...
                        <div class="actions">
                            <a href="{{ route('evenement.show', $evenement->id) }}">Voir</a>
                            <a href="{{ route('evenement.edit_view', $evenement->id) }}">Modifier</a>
                            <a href="{{ route('evenement.delete', $evenement->id) }}">Supprimer</a>
                        </div>
                    </article>
                @endforeach
            </div>
            ...
            <div>
                ...
                @foreach($boutiques as $boutique)
                    <article>
                        ...
                        <div>
                            <a href="{{ route('boutique.show', $boutique->id) }}">Voir</a>
                            <a href="{{ route('boutique.edit_view', $boutique->id) }}">Modifier</a>
                            <a href="{{ route('boutique.delete', $boutique->id) }}">Supprimer</a>
                        </div>
                    </article>
                @endforeach
            </div>
            ...
            <div>
                <h1>Catalogues</h1>
                <a href="{{ route('catalogue.create') }}">Ajouter</a>
                @foreach($catalogues as $catalogue)
                    <article>
                        ...
                        <div>
                            <a href="{{ route('catalogue.show', $catalogue->id) }}">Voir</a>
            ...
            <div>
                ...
                @foreach($produits as $produit)
                    <article>
                        ...
                        <div>
                            <a href="{{ route('produit.show', $produit->id) }}">Voir</a>
